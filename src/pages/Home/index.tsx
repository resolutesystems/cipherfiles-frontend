            ...
            {state === "selecting" || state === "uploading" ? (
                <div>
                    ...
                    <form class="flex flex-col" method="post" enctype="multipart/form-data">
                        ...
                        {state === "selecting" && (
                            <label class="flex flex-col items-center bg-neutral-800/50 py-6 rounded-lg border-2 border-neutral-700/30 cursor-pointer transition-colors hover:bg-neutral-800/70">
