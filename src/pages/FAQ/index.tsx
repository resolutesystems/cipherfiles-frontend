...
export function FAQ() {
    ...
    const faqItemsData = [
        ...
        },
        {
            ...
            description: translatedText(`We do not store any data about you nor how you use the service. You can read more at <a class=\"text-accent link\" href=\"/terms-of-service\">terms of service</a>.`),
        },
        {
